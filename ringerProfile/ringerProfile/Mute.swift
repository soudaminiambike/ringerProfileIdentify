...
public class Mute: NSObject {
    ...
    private let soundUrl = "Mute.bundle"
...
//        guard let path = Bundle.main.path(forResource: "sound", ofType:nil) else {
...
//        NotificationCenter.default.removeObserver(self)
    ...
    private func playSound() {
        if !self.isPaused {
            ...
            self.isPlaying = true
            AudioServicesPlaySystemSoundWithCompletion(1016) { [weak self] in
